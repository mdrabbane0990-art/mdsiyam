...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "নিশি") || (event.body.toLowerCase() == "miss you")) {
     return api.sendMessage("<আমি তোমাকে রাইতে মিস খাই🥹🤖 🫵খবরদার কেউ নজর দিবি 🤬না এগুলা আমার বস সিয়ামের🎀👈 নজর দিলে নুনু 🙈কেটে ফেলবো🥳 তৃষা 🤩মায়া😘 নিশি 😘 মুনতাহা😘 এগুলা 😘সব আমার 😓 বস সিয়ামের 😏🎀👅/👅-✘  🎀 🍒:))", threadID);
   };

    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("bot owner=𝕌𝕕𝕒𝕪 ℍ𝕒𝕤𝕒𝕟 𝕊𝕚𝕪𝕒𝕞_নাম-সিয়াম।{বাসা} কিশোরগঞ্জ-[বয়স]16+-[ক্লাস} 10_{Facebook]:https://www.facebook.com/profile.php?id=61568411310748 %₹$[whatsapp]+8801789138157 [Prefix][/} আশা করি🤌 এই বট ব্যবহার করে আপনাদের খুব🧑‍🚒 ভালো লাগবে🤺 আপনাদেরকে 💝আরো ভালো কিছু দেওয়ার চেষ্টা করব ইনশাআল্লাহ💓 দোয়া করবেন ☃️কেউ যদি বানিয়ে নিতে চান তাহলে😴 ইনবক্স করুন অথবা 👈 🫰হোয়াটসঅ্যাপে যোগাযোগ করুন 🎀🤬", threadID);
   };
   
    if ((event.body.toLowerCase() == "help") || (event.body.toLowerCase() == "help")) {
     return api.sendMessage("type /help", threadID);https:'//www.facebook.com/profile.php?id=61568411310748",
   };
  ...
  if ((event.body.toLowerCase() == "সিয়াম") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎মাদারচোদ🙈 তোর মায়েরে চুদি😓 তুই চিনোস না কেন 😏😘[𝐎𝐖𝐍𝐄𝐑:☞ 𝕌𝕕𝕒𝕪 ℍ𝕒𝕤𝕒𝕟 𝕊𝕚𝕪𝕒𝕞 ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61568411310748\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01789138157", threadID);
   };

   if ((event.body.toLowerCase() == "তোমার বস কে") || (event.body.toLowerCase() == "admin")) {
     return api.sendMessage("My Creator: 𝐒𝐢𝐲𝐚𝐦 𝐇𝐚𝐬𝐚𝐧❤️ হাই আমি মেছেন্জার ROBOT  আামার বস সিয়াম আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি🥳🫰 থাকেন👉 আর নিশিকে 🫶 আমার বস সিয়ামের 🤝 হাতে তুলে দেন🙏😵‍💫", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝐒𝐢𝐲𝐚𝐦 𝐇𝐚𝐬𝐚𝐧 ッ❤️ তাকে সবাই সিয়াম নামে  চিনে🤙 🙈খানকির ছেলে তুই চিনিস না কেন🤬 মেয়ে হলে খাটে নিয়ে যামু🙈 লুট নিতে পারবি না🙈🙏 সরি প্রিয় মেম্বার 💝🤌😘", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
     return api.sendMessage("️- ওয়ালাইকুমুস-সালাম-!!🖤 বসতে আমের পক্ষ থেকে আপনাকে জানাই অনেক শুভেচ্ছা নিশিকে আমার বস সিয়ামের হাতে তুলে দেন", threadID);
   };

   if ((event.body.toLowerCase() == "সিয়াম আমি তোর বস") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏 তোমাকে চিনতে পারি নাই 🥺💨 হালার পুতে এগুলা কপি করে তোমার কাছ থেকে", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Nishi Islam ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস সিয়াম এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "নিশি")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সিয়াম এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "তৃষা")) {
  ...
  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "farhana")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সিয়াম এর কিউট সুইট দুষ্টু বুড়ি বেস্ট টু..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "siyam") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম না বলে নিশি কে আমার বস সিয়াম এর হাতে তুলে দে🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "তোমার নাম কি") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝐒𝐢𝐲𝐚𝐦 𝐇𝐚𝐬𝐚𝐧 𝐜𝐡𝐚𝐭 𝐛𝐨𝐭", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "আমি সিয়াম") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("হ্যা বস কেমন আছেন..?☺️ আমাদের হবু ভাবি নিশি কেমন আছে", threadID);
   };
  mess = "{name}"
